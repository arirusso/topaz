...
By default, the block will be called at quarter note intervals, but other intervals can be used such as in this case 16th notes.  This is used the same way for both internal and external clock.
