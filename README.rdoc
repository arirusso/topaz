...
MIDI syncable tempo generation and analysis in Ruby
...
To view the current tempo (this will give you a calculated tempo for external clock if you're using it) 
